...
bool World::init(vec2 screenSize, vec2 worldSize) {
    ...
    m_background_music.openFromFile(audio_path("music.wav"));
    m_background_music.play();
    m_playershooting_music.openFromFile(audio_path("shooting.wav"));
    m_itemcollect_music.openFromFile(audio_path("pickupItems.wav"));
    m_aliendeath_music.openFromFile(audio_path("alienDeath.wav"));
    m_bomb_music.openFromFile(audio_path("bombExplosion.wav"));
    m_hit_music.openFromFile(audio_path("hitCity.wav"));
    m_gameover_music.openFromFile(audio_path("gameOver.wav"));
...
//        return false;
//    }
//    auto m_background_music = Mix_LoadWAV(audio_path("music.wav"));
////    m_player_shooting_music = Mix_LoadWAV(audio_path("shooting.wav"));
////    m_aliendeath_music = Mix_LoadWAV(audio_path("alienDeath.wav"));
////    m_itemcollect_music = Mix_LoadWAV(audio_path("pickupItems.wav"));
////    m_city_music = Mix_LoadWAV(audio_path("hitCity.wav"));
////    m_bomb_music = Mix_LoadWAV(audio_path("bombExplosion.wav"));
//    if ( m_background_music == nullptr )
//        //|| m_player_shooting_music == nullptr || m_aliendeath_music == nullptr || m_itemcollect_music == nullptr
//    //|| m_city_music == nullptr || m_bomb_music == nullptr
//    {
...
////        // Shooter attacking city
//        shooterBulletIt = shooter->getBullets().begin();
//        while (shooterBulletIt != shooter->getBullets().end()) {
//            bool isColliding = false;
//            auto bshooter_it = m_shooters.begin();
//            if (m_background->colCheck1(**shooterBulletIt)) {
//                shooterBulletIt = shooter->getBullets().erase(shooterBulletIt);
//                isColliding = true;
//                m_background->decreaseHealth();
//                m_hit_music.play();
//                break;
//            } else if (m_background->colCheck2(**shooterBulletIt)) {
//                shooterBulletIt = shooter->getBullets().erase(shooterBulletIt);
//                isColliding = true;
//                m_background->decreaseHealth();
//                m_hit_music.play();
//                break;
//            } else if (m_background->colCheck3(**shooterBulletIt)) {
//                shooterBulletIt = shooter->getBullets().erase(shooterBulletIt);
//                isColliding = true;
//                m_background->decreaseHealth();
//                m_hit_music.play();
//                break;
//            } else if (m_background->colCheck4(**shooterBulletIt)) {
//                shooterBulletIt = shooter->getBullets().erase(shooterBulletIt);
//                isColliding = true;
//                m_background->decreaseHealth();
//                m_hit_music.play();
//                break;
//            } else if (m_background->colCheck5(**shooterBulletIt)) {
//                shooterBulletIt = shooter->getBullets().erase(shooterBulletIt);
//                isColliding = true;
//                m_background->decreaseHealth();
//                m_hit_music.play();
